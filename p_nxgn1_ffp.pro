...
if err eq 0 then begin
    ...
    ; compute average image and write it out for potential later use

    ; throw out first x seconds

    ;print, "throwing out x seconds for average

    for j = 0, num_frames_to_skip - 1 do begin
      readu, 1, fr_no
      readu, 1, frame
    endfor
    print, "starting at : ", j+1
    ;readu, 1, frame
     ; readu, 1, frame

    for j = j + 1, ffilm_l - 1 do begin
...
print, ""
openr, 1, "D:\Jingzhou\070923\mapping\hel3.map" ;
